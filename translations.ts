...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'settings.storage.description': "Pour que l'upload d'images fonctionne, suivez les étapes ci-dessous.",
    'settings.storage.copy_button': "Copier le script SQL",
    'settings.storage.copied_button': "Copié !",
    'settings.storage.step1_title': "Étape 1 : Allez sur Supabase",
    'settings.storage.step1_desc': "Ouvrez votre tableau de bord de projet Supabase.",
    'settings.storage.step2_title': "Étape 2 : Trouvez l'éditeur SQL",
    'settings.storage.step2_desc': "Naviguez vers la section 'Database', puis cliquez sur 'SQL Editor'.",
    'settings.storage.step3_title': "Étape 3 : Copiez & Collez le script",
    'settings.storage.step3_desc': "Copiez le script ci-dessous et collez-le dans l'éditeur SQL.",
    'settings.storage.step4_title': "Étape 4 : Exécutez le script",
    'settings.storage.step4_desc': "Cliquez sur 'RUN' pour exécuter le script et créer le stockage d'images.",
    'settings.storage.test_button': "Tester la connexion au stockage",
    'settings.storage.testing': "Test en cours...",
    'settings.storage.test_success': "Succès ! Le stockage est correctement configuré. Vous pouvez maintenant ajouter des produits avec des images.",
    'settings.storage.test_error_bucket': "Échec du test : Le bucket 'product-images' est introuvable. Veuillez suivre les 4 étapes ci-dessus pour exécuter le script SQL.",
    'settings.storage.test_error_generic': "Échec du test : une erreur est survenue ({error}). Veuillez vérifier que le script a été exécuté correctement.",
    ...
    'error.bucket_not_found': "Erreur de stockage : 'Bucket' introuvable. Veuillez vous rendre sur la page Paramètres, suivre le guide de configuration en 4 étapes et utiliser le bouton de test pour vérifier votre configuration.",
  },
  en: {
    'save': 'Save',
    'cancel': 'Cancel',
    ...
    'settings.storage.description': "For image uploads to work, follow the steps below.",
    'settings.storage.copy_button': "Copy SQL Script",
    'settings.storage.copied_button': "Copied!",
    'settings.storage.step1_title': "Step 1: Go to Supabase",
    'settings.storage.step1_desc': "Open your Supabase project dashboard.",
    'settings.storage.step2_title': "Step 2: Find SQL Editor",
    'settings.storage.step2_desc': "Navigate to the 'Database' section, then click 'SQL Editor'.",
    'settings.storage.step3_title': "Step 3: Copy & Paste Script",
    'settings.storage.step3_desc': "Copy the script below and paste it into the SQL editor.",
    'settings.storage.step4_title': "Step 4: Run Script",
    'settings.storage.step4_desc': "Click 'RUN' to execute the script and create the image storage.",
    'settings.storage.test_button': "Test Storage Connection",
    'settings.storage.testing': "Testing...",
    'settings.storage.test_success': "Success! Storage is configured correctly. You can now add products with images.",
    'settings.storage.test_error_bucket': "Test Failed: The 'product-images' bucket was not found. Please follow the 4 steps above to run the SQL script.",
    'settings.storage.test_error_generic': "Test Failed: An error occurred ({error}). Please ensure the script was run correctly.",
    ...
    'error.bucket_not_found': "Storage Error: Bucket not found. Please go to the Settings page, follow the 4-step setup guide, and use the test button to verify your configuration.",
  },
  ar: {
    'save': 'حفظ',
    'cancel': 'إلغاء',
    ...
    'settings.storage.description': "لكي تعمل عمليات تحميل الصور، اتبع الخطوات أدناه.",
    'settings.storage.copy_button': "نسخ البرنامج النصي SQL",
    'settings.storage.copied_button': "تم النسخ!",
    'settings.storage.step1_title': "الخطوة 1: اذهب إلى Supabase",
    'settings.storage.step1_desc': "افتح لوحة تحكم مشروع Supabase.",
    'settings.storage.step2_title': "الخطوة 2: ابحث عن محرر SQL",
    'settings.storage.step2_desc': "انتقل إلى قسم 'Database'، ثم انقر على 'SQL Editor'.",
    'settings.storage.step3_title': "الخطوة 3: انسخ والصق النص",
    'settings.storage.step3_desc': "انسخ النص أدناه والصقه في محرر SQL.",
    'settings.storage.step4_title': "الخطوة 4: قم بتشغيل النص",
    'settings.storage.step4_desc': "انقر على 'RUN' لتنفيذ النص وإنشاء مخزن الصور.",
    'settings.storage.test_button': "اختبار اتصال التخزين",
    'settings.storage.testing': "جاري الاختبار...",
    'settings.storage.test_success': "نجاح! تم تكوين التخزين بشكل صحيح. يمكنك الآن إضافة منتجات بالصور.",
    'settings.storage.test_error_bucket': "فشل الاختبار: الحاوية 'product-images' غير موجودة. يرجى اتباع الخطوات الأربع أعلاه لتشغيل برنامج SQL النصي.",
    'settings.storage.test_error_generic': "فشل الاختبار: حدث خطأ ({error}). يرجى التأكد من تشغيل البرنامج النصي بشكل صحيح.",
    ...
    'error.bucket_not_found': "خطأ في التخزين: 'Bucket' غير موجود. يرجى الانتقال إلى صفحة الإعدادات، واتباع دليل الإعداد المكون من 4 خطوات، واستخدام زر الاختبار للتحقق من الإعدادات الخاصة بك.",
  },
};