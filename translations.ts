...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'settings.data_stats': '{products} produits, {sales} ventes, {activities} activités',
  ...
  en: {
    ...
    'settings.data_stats': '{products} products, {sales} sales, {activities} activities',
  ...
  ar: {
    ...
    'settings.data_stats': '{products} منتجات، {sales} مبيعات، {activities} أنشطة',
