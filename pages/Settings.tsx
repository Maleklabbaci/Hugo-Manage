...
const sqlScript = `-- This is a complete setup script for your Supabase project.
-- Run this ONCE in your Supabase SQL Editor.
-- It will create the necessary tables, security policies, and storage bucket.
...
CREATE TABLE IF NOT EXISTS public.products (
    ...
    category text,
    supplier text,
    buyprice numeric(10, 2) DEFAULT 0,
    sellprice numeric(10, 2) DEFAULT 0,
