...
export const ChezHugoLogo: React.FC<{ className?: string }> = ({ className }) => {
    return (
        <div className={`relative inline-block ${className}`}>
            <svg viewBox="0 0 200 80" className="absolute -inset-4 w-[calc(100%+2rem)] h-[calc(100%+2rem)] z-0 text-brand" fill="none" stroke="currentColor" strokeWidth="12" strokeLinecap="round">
            ...
            <div style={{ fontFamily: "'Permanent Marker', cursive" }} className="relative z-10 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">
